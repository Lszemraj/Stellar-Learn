...
# 'Grids_Mstar_IllustrisTNG_1P_128_z=0.0.npy'
# 'Grids_Mstar_IllustrisTNG_CV_512_z=0.5.npy'
# 'Grids_Mstar_IllustrisTNG_CV_512_z=1.0.npy'
# 'Grids_Mstar_IllustrisTNG_EX_512_z=1.5.npy'
# 'Grids_Mstar_IllustrisTNG_CV_512_z=2.0.npy'

filename = 'Grids_Mstar_IllustrisTNG_CV_512_z=2.0.npy'
...
plt.tight_layout()
plt.savefig(f"images/powerspectrum_{z}_combined.png", dpi=300)
plt.show()
...
surf_nods = grid3d.sum(axis=proj_ax)
'''
mask = (surf == 0)
...
positive_nods = surf_nods[surf_nods > 0]
#vmin = positive.min()  
#print("vmin:", vmin)
#print("max:", surf.max())
#vmax = surf.max()
vmin = 14032811000.0
vmax = 1665256300000000.0
